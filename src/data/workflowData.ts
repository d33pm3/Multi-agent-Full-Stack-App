...
export const noticeResponses: NoticeResponse[] = [
  {
    ...
    internalActions: [
      { date: '2026-03-06', action: 'Notice logged in the Response Tracker and linked to the Compliance Master', by: 'Demo Owner A (CS)' },
      { date: '2026-03-10', action: 'Board Committee briefed; draft reply circulated', by: 'Demo Owner C (Legal)' },
      { date: '2026-03-18', action: 'Reply filed with SEBI along with the filed report', by: 'Demo Owner A (CS)' },
    ],
    correspondence: [
  ...
  },
  {
    ...
    internalActions: [
      { date: '2026-04-03', action: 'Notice logged; external counsel engaged and SDD frozen for audit', by: 'Demo Owner C (Legal)' },
      { date: '2026-04-08', action: 'Trading window records and Form C/D disclosures compiled for the inquiry period', by: 'Demo Owner A (CS)' },
      { date: '2026-04-15', action: 'Draft reply under review by the Audit Committee Chair', by: 'Demo Approver B (Audit Chair)' },
    ],
    correspondence: [
  ...
  },
  {
    ...
    internalActions: [
      { date: '2026-02-19', action: 'Fine computation verified against the SOP Circular', by: 'Demo User B (CFO)' },
      { date: '2026-02-28', action: 'Fine paid and explanation letter filed; exchange confirmed closure', by: 'Demo User B (CFO)' },
    ],
    correspondence: [
  ...
  },
  {
    ...
    internalActions: [
      { date: '2026-04-11', action: 'Advisory circulated to Finance and the Secretarial team', by: 'Demo User D (Compliance)' },
      { date: '2026-04-20', action: 'Test filing completed on the exchange portal in the new taxonomy', by: 'Demo Owner E (Finance)' },
    ],
    correspondence: [
...
export const approverDirectory: Record<string, string> = {
  'Demo Approver A (Director)': 'demo.approver.a@example.com',
  'Demo Approver B (Audit Chair)': 'demo.approver.b@example.com',
  'Demo Approver C (MD)': 'demo.approver.c@example.com',
  'Demo Approver D (ID)': 'demo.approver.d@example.com',
};
